...
RULES = [
    ...
    # Цілі відкалібровані по факту вичищених файлів, а не розрахунково.
    # Контраст 5.5: після повного проходу по всіх 12 темах лишилося 5.4, і
    # те, що лишилося, — зміст, а не тик. «Механізмом, а не порадою»,
    # «відповідь — властивість системи, а не настрій моделі», «різниця між
    # „модель переконали“ і „система зробила“»: на цих протиставленнях
    # побудована дидактика курсу, прибрати їх означало б прати думку.
    ("контраст «не X, а Y»", r",\s+а не\b|—\s+а\b|\bЦе не\b|\bне просто\b|\bне\s+\w+,\s+а\b", 5.5,
