...
Довідник для **того, хто публікує матеріали** (LMS чи будь-яка інша
платформа — автор до публікації стосунку не має, його зона закінчується на
готовому контенті й відео). Що входить у заняття N, звідки це брати і в якому
...
| # | Тиждень | Канонічна назва | HTML-матеріал заняття | Конспект | Бранч еталона (лаба) | ДЗ у складі заняття | Відео | Зміст | Відео-статус | Дата публікації |
|---|---|---|---|---|---|---|---|---|---|---|
