...
Єдине джерело для production-команди: що входить у заняття N, звідки це брати
і в якому воно статусі. Канонічна назва заняття = `<title>` лонг-ріда.
Статуси відео/дати заповнює production-команда; правило rolling-буфера —
...
| Гайд ментора | docs/MENTOR_GUIDE.md | ментору до старту потоку |
