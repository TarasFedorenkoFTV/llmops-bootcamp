...

{
  ...
  D.band(s, { x: MX, y: 6.4, w: 12.1, h: 0.62, tone: "card", text: "Від «одна модель на все» — до розведеного трафіку, який видно в базі." });
}
...

{
  ...
  D.tile(s, { x: 7.9, y: 3.05, w: 4.82, h: 1.1, title: "drop_params: true", body: "адаптер відкидає поля, яких провайдер не приймає", tone: "good" });
  D.tile(s, { x: 7.9, y: 4.25, w: 4.82, h: 1.1, title: "num_retries: 0", body: "збої долітають до сервісу — він вирішує, що робити", tone: "warn" });
...

{
  ...
  D.band(s, { x: MX, y: 4.85, w: 12.1, h: 1.0, tone: "card",
