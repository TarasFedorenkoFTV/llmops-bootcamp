...

{
  ...
  D.tile(s, { x: MX, y: 1.9, w: 3.9, h: 2.35, title: "Прохання ≠ подія", body: "модель просить, сервіс вирішує і виконує — межа видима в коді", tone: "good" });
  D.tile(s, { x: 4.72, y: 1.9, w: 3.9, h: 2.35, title: "Читання безпечне", body: "повтор lookup_order коштує зайвий запит у базу — і все", tone: "acc" });
  D.tile(s, { x: 8.82, y: 1.9, w: 3.9, h: 2.35, title: "Незворотне — ні", body: "два тікети на одне питання: дірка HITL і відсутність ідемпотентності", tone: "crit" });
