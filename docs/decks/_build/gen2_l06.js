...

{
  ...
  D.band(s, { x: MX, y: 5.55, w: 12.1, h: 1.15, tone: "acc", label: "Навіщо",
    text: "Побачити межу власними очима: читання виконується спокійно, а незворотна дія двічі створює зобов'язання — обидві дірки закриваються у наступній темі." });
}
...

{
  ...
  D.band(s, { x: MX, y: 5.85, w: 12.1, h: 0.8, tone: "card",
    text: "Різниця між «попросила» і «зробила» — суть цієї теми. У наступній між ними стане людина." });
}
