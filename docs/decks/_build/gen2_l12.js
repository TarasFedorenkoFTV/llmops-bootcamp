...

{
  ...
  [["01","Від трьох рядків до контуру"],["02","Точка Б: сценарій наскрізь"],["03","Runbook як сценарій"],
   ...
   ["10","За межами курсу"],["11","Лабораторна"],["12","Антипатерни фіналу"],
      ...
      badge: n, title: t, tone: n === "07" ? "warn" : (i < 5 ? "acc" : "card") }));
  D.band(s, { x: MX, y: 6.4, w: 12.1, h: 0.62, tone: "card", text: "Від зібраної системи — до впевненого володіння нею." });
}
...

{
  ...
  D.band(s, { x: MX, y: 5.92, w: 12.1, h: 0.95, tone: "good", label: "Чому саме цей порядок",
