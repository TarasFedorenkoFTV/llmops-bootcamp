...

{
  ...
  D.tile(s, { x: MX, y: 1.9, w: 3.9, h: 2.35, title: "Метрика, а не віра", body: "hit/miss ростуть на очах: економія порахована, а не заявлена", tone: "good" });
  D.tile(s, { x: 4.72, y: 1.9, w: 3.9, h: 2.35, title: "Ключ вирішує коректність", body: "промпт у ключі — і rollback не залишає стару поведінку", tone: "acc" });
  D.tile(s, { x: 8.82, y: 1.9, w: 3.9, h: 2.35, title: "Межа проведена", body: "персональне й tool-відповіді не кешуються ніколи", tone: "crit" });
