...

{
  ...
  [["Персональні відповіді", "«Де моє замовлення?» — закешували одному, віддали іншому: інцидент із чужими даними"],
   ["Результати tool-викликів", "зібрані зі стану зовнішньої системи в конкретну мить — за годину бре­шуть"],
...

{
  ...
  D.table(s, { x: MX, y: 3.75, w: 12.1, colW: [3.0, 5.0, 4.1], rowH: 0.62, size: 11.5,
  ...
  D.band(s, { x: MX, y: 5.85, w: 12.1, h: 0.72, tone: "card",
    text: "Буває, ваш кеш майже не влучає, а рахунок нижчий за очікуваний — це працює кеш провайдера. Дивіться на обидві цифри." });
}
