...
D.closingSlide({
  ...
  nextBody: "Система переживає збій провайдера. У наступній темі — про збої іншого роду: коли шкоду завдає не інфраструктура, а зміст. Injection, витік даних і незворотні дії, які мусить підтвердити людина — та сама «дірка», яку ми лишили відкритою на уроці 6.",
  notes: N(),
});
