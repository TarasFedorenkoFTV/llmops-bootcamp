...
Конспекти L07/L08 виправлені: CB і guardrail позначені опційними — конспекти,
hw4 і лонг-ріди узгоджені. Еталон w3 виправлено: tool-відповіді не кешуються
вже на w3 (`toolCall == null`), як і каже L05.
